...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const { token,empId, email } = response.data;
      localStorage.setItem("data", token,empId, email); 
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <a href="/register" className="font-semibold text-green-600 hover:text-indigo-500">
              Register
            </a>
          </p>
        </div>
